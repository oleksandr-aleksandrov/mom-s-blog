...
<div class="swift-p-row" id="cloudflare-email-container">
      ...
      <input type="text" name="options[cloudflare-email]" id="cloudflare-email" value="<?php echo esc_attr(Swift_Performance_Lite::get_option('cloudflare-email'));?>">
...
<div class="swift-p-row" id="cloudflare-api-key-container">
      ...
      <input type="text" name="options[cloudflare-api-key]" id="cloudflare-api-key" value="<?php echo esc_attr(Swift_Performance_Lite::get_option('cloudflare-api-key'));?>">
...
<div class="swift-p-row" id="custom-varnish-host-container">
      ...
      <input type="text" name="options[custom-varnish-host]" id="custom-varnish-host" value="<?php echo esc_attr(Swift_Performance_Lite::get_option('custom-varnish-host'));?>">
