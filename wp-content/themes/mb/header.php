...
<header uk-sticky="cls-active:uk-active-header-sticky">
    <div id="header">
        <nav class="uk-container" uk-navbar>
            ...
            <a href="#modal-full-mobile-menu" class="uk-hidden@m uk-navbar-right uk-text-muted"
               uk-toggle>
                <span uk-navbar-toggle-icon></span>
                <span class="uk-margin-small-left"></span>
            </a>
            <div id="modal-full-mobile-menu" class="uk-modal-full uk-modal" uk-modal>
                <button class="uk-modal-close-full uk-modal-close-full-custom uk-padding-large uk-close-large"
                        type="button"
                        uk-close></button>
        ...
        <div id="modal-full-search" class="uk-modal-full uk-modal" uk-modal>
            <div class="uk-modal-dialog  uk-modal-dialog-custom-color uk-flex uk-flex-center uk-flex-middle"
                ...
                <form role="search" method="get"
                      class="search-form uk-text-center uk-search uk-search-large uk-visible@m"
                      action="<?php echo home_url('/'); ?>">
                    <p class="mb-search-description-header uk-margin-remove"><?php _e('Введiть пошуковий запит', 'mb'); ?></p>
                    <i class="uk-text-snow" uk-icon="icon:  chevron-down; ratio: 2"></i>
