            ...
            foreach ($last_posts as $last_post) {
                ...
                <div class="uk-width-expand@m uk-grid-item-match">
                    <div class="uk-margin uk-text-left@s uk-text-center uk-card uk-card-default uk-card-hover">
                        <a class="uk-position-cover uk-position-z-index uk-margin-remove-adjacent"
                           href="<?php echo get_permalink($last_post['ID']) ?>"></a>
                        <div class="uk-card-media-top">
                            <?php
                            if (has_post_thumbnail()) {
                                echo get_the_post_thumbnail($last_post['ID'], 'medium', array('class' => 'uk-image-blog uk-box-shadow-medium'));
                            } else { ?>
                                <img class="uk-image-blog uk-box-shadow-medium"
                                     src="<?php bloginfo('template_url') ?>/app/img/wheat11.jpg" alt="">
                            <?php }
                            ?>
                        </div>
